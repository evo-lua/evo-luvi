...
local benchmark = Benchmark("Throughput: Raw llhttp calls via FFI (zero overhead)")
...
local parserState
local websocketsRequestString =	"GET /chat HTTP/1.1\r\nHost: example.com:8000\r\nUpgrade: websocket\r\nConnection: Upgrade\r\nSec-WebSocket-Key: dGhlIHNhbXBsZSBub25jZQ==\r\nSec-WebSocket-Version: 13\r\n\r\n"
...
function benchmark:OnReport(runTimeInNanoseconds, numIterationsPerformed)
	...
	printf("Parsed %d requests in %.2f ms (%.2fs)", numIterationsPerformed, elapsedTimeInMilliseconds, elapsedTimeInMilliseconds/1000)
