...
local llhttp = {
	...
	FFI_EVENTS = {
		[0] = "LLHTTP_FFI_BUFFER_TOO_SMALL",
		"LLHTTP_FFI_ON_MESSAGE_BEGIN",
		"LLHTTP_FFI_ON_URL",
		"LLHTTP_FFI_ON_STATUS",
		"LLHTTP_FFI_ON_METHOD",
		"LLHTTP_FFI_ON_VERSION",
		"LLHTTP_FFI_HEADER_FIELD",
		"LLHTTP_FFI_ON_HEADER_VALUE",
		"LLHTTP_FFI_ON_CHUNK_EXTENSION_NAME",
		"LLHTTP_FFI_ON_CHUNK_EXTENSION_VALUE",
		"LLHTTP_FFI_ON_HEADERS_COMPLETE",
		"LLHTTP_FFI_ON_BODY",
		"LLHTTP_FFI_ON_MESSAGE_COMPLETE",
		"LLHTTP_FFI_ON_URL_COMPLETE",
		"LLHTTP_FFI_ON_STATUS_COMPLETE",
		"LLHTTP_FFI_ON_METHOD_COMPLETE",
		"LLHTTP_FFI_ON_VERSION_COMPLETE",
		"LLHTTP_FFI_ON_HEADER_FIELD_COMPLETE",
		"LLHTTP_FFI_ON_HEADER_VALUE_COMPLETE",
		"LLHTTP_FFI_ON_CHUNK_EXTENSION_NAME_COMPLETE",
		"LLHTTP_FFI_ON_CHUNK_EXTENSION_VALUE_COMPLETE",
		"LLHTTP_FFI_ON_CHUNK_HEADER",
		"LLHTTP_FFI_ON_CHUNK_COMPLETE",
		"LLHTTP_FFI_ON_RESET",
	},
